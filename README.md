Juego del laberinto, el cual genera el mapa de forma aleatoria, y se buscan las adyacencias, para proponer la solución al jugador, usando el algoritmo de "Búsqueda primero en profundidad"
